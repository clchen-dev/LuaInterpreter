...
// Dump serializes a function prototype into a Lua 5.3 binary chunk.
func Dump(p *Prototype) ([]byte, error) {
...
func WriteFile(path string, p *Prototype, permission os.FileMode) error {
	data, err := Dump(p)
	if err != nil {
		return err
	}
